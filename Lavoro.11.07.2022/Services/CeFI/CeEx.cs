...
{  
    //public class CeEx: IFCeFi, IPaymentService, ICreditSevice
    //{

    //}
    //public class CeExCredit : IFCeFi, ICreditSevice
    //{
    //    class CeExAccount :Account
    //    {
    //        public CeExAccount(string WalletAddress):base(WalletAddress)
    //        {
    ...
    //    }
    //} 
    //public class CeExPayment: IFCeFi, IPaymentService
    //{
